...
def zip_integrity():
    zpath = ROOT / "neuralscreen-v1.5.6-full.zip"
    if not zpath.is_file():
        return False, "no neuralscreen-v1.5.6-full.zip"
    required = [
        "main.py", "gpuinfo.py", "overlay_ui.py", "i18n.py", "recorder.py",
        "display.py", "guides.py", "hotkeys.py", "tray.py", "capture.py",
        "audio.py", "protocol.py", "winapi.py", "dialogs.py",
        "NeuralScreen.exe",
    ...
    with zipfile.ZipFile(zpath) as z:
        ...
        if "NeuralScreen 1.5.6" not in vt:
            return False, "VERSION.txt version does not match v1.5.6"
