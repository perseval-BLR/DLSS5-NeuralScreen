...
NVIDIA App его не видят. В режиме окна - видят. Запись: выберите окно в
меню, запустите запись в OBS / NVIDIA App, вернитесь на весь экран когда
закончите. Свёрнутое окно ставит обработку на паузу.
...
задумано. Звук записи проходит через мягкий лимитер, так что громкий
системный микс не даст клиппинга и искажений.
...
- **NVIDIA App / OBS display capture:** используйте режим одного окна -
  ...
  записывайте, затем вернитесь на **«Во весь экран»** когда закончите. В
...
- **Список окон** — все видимые окна; Num5 берёт окно под курсором. **Второй монитор** работает, но окно между мониторами не тестировалось.
